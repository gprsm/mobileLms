export default {
  ...
  settings: {
    ...
    emptyCurrentPassword: 'Current password is required',
  ...
  learningScreen: {
    ...
    quiz: {
      ...
      noQuestion: 'No questions is available',
    },
    assignment: {
      title: 'Assignment',
      ...
      chooseFileDescription:
        '(Maximum amount of files you can upload more: {{files_amount}}. And allow upload only these types: {{allow_file_type}})',
      save: 'SAVE',
      send: 'SEND',
  ...
  notification: {
    ...
    error: 'Error when get notifications',
  },
  reviews: {
    title: 'Reviews',
    empty: 'No reviews',
